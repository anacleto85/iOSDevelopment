...
public enum FilterNames {
    ...
    // 5 times green difference filter
    case GreenDiffFilterX5
    
    // 5 times blu difference filter
    case BluDiffFilterX5
}
...
public struct DefaultFilterManager {
    ...
    public init() {
        ...
        self.predefinedFilters = [FilterNames.Brightness50p : BrightnessFilter(brightness: -128),
            ...
            FilterNames.GreenDiffFilterX5 : GreenDiffFilter(lambda: 5),
            FilterNames.BluDiffFilterX5 : BlueDiffFilter(lambda: 5)]
    }
